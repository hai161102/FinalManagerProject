...
namespace ManagerCotrol.views.activity
{
    internal class SignUpActivity : PanelView
    {
        ...
        private TextBox textBoxUser, textBoxPass, textBoxPermission;
        ...
        {
            return this.textBoxUser;
        }

        public TextBox getPass()
        {
            return this.textBoxPass;
        }

        public TextBox getPermission()
        {
            return textBoxPermission;
        }
        ...
        private void onTextChange(object sender, EventArgs e)
        {
            ...
            if (textBox.Name == listLabelText[2])
            {
                textBoxPermission = textBox;
            }
        }
